...
public class ThreadDownloadImageData extends SimpleTexture
{
    ...
    private void checkTextureUploaded()
    {
        if (!this.textureUploaded && this.bufferedImage != null)
        {
            ...
            {
                net.minecraft.client.renderer.texture.TextureUtil.uploadTextureImage(super.getGlTextureId(), this.bufferedImage);
            }
        }
    }
            ...
            public void run()
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            bufferedimage = net.minecraft.client.renderer.texture.TextureUtil.readBufferedImage(httpurlconnection.getInputStream());
                        }
    ...
    private void loadPipelined()
    {
        try
        {
            ...
            {
                bufferedimage = net.minecraft.client.renderer.texture.TextureUtil.readBufferedImage(bytearrayinputstream);
            }
