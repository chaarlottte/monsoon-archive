    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || Wrapper.monsoon.moduleManager.getModule(Aura.class).shouldRenderBlockAnim())
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            EventRenderBlocking event = new EventRenderBlocking(f, f1);
