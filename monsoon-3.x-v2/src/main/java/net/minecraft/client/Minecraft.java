...
import wtf.monsoon.client.event.EventRightClick;
import wtf.monsoon.client.util.misc.Time;
import wtf.monsoon.misc.via.utils.AttackOrder;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void rightClickMouse()
    {
        if (!this.playerController.func_181040_m())
        {
            ...
            {
                EventRightClick event = new EventRightClick(this.objectMouseOver.typeOfHit);
    ...
    {
        Wrapper.getMonsoon().getBus().post(new EventClientTick());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        Wrapper.getMonsoon().getBus().post(new EventKey(k));
