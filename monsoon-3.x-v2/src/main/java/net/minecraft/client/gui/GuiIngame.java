...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Wrapper.getMonsoon().getNvg().beginFrame();
        Wrapper.getMonsoon().getBus().post(new EventRender2D(scaledresolution, Display.getWidth(), Display.getHeight()));
        TempRenderer.INSTANCE.render();
        Wrapper.getMonsoon().getNvg().endFrame();
