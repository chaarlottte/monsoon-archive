...
public class Block
{
    ...
    {
        EventBlockCollide blockCollideEvent = new EventBlockCollide(this.getCollisionBoundingBox(worldIn, pos, state), state.getBlock(), (double) pos.getX(), (double) pos.getY(), (double) pos.getZ());
        Wrapper.monsoon.bus.post(blockCollideEvent);

        if (blockCollideEvent.getCancelled()) return;
