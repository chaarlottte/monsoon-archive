...
public class C0EPacketClickWindow implements Packet<INetHandlerPlayServer>
{
    ...
    @Identifier(identifier = "get_window_id")
    ...
    @Identifier(identifier = "get_used_button")
    public int getUsedButton()
    {
        return this.usedButton;
    }

    @Identifier(identifier = "get_action_number")
    public short getActionNumber()
    {
        return this.actionNumber;
    }

    @Identifier(identifier = "get_clicked_item")
    public ItemStack getClickedItem()
    {
        return this.clickedItem;
    }

    @Identifier(identifier = "get_mode")
    public int getMode()
    {
        return this.mode;
    }
