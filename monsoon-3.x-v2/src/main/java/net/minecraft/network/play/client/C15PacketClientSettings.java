...
public class C15PacketClientSettings implements Packet<INetHandlerPlayServer>
{
    ...
    @Identifier(identifier = "get_lang")
    public String getLang()
    {
        return this.lang;
    }

    @Identifier(identifier = "get_chat_visibility")
    public EntityPlayer.EnumChatVisibility getChatVisibility()
    {
        return this.chatVisibility;
    }

    @Identifier(identifier = "is_colors_enabled")
    public boolean isColorsEnabled()
    {
        return this.enableColors;
    }

    @Identifier(identifier = "get_model_part_flags")
