...
import store.vantage.api.RequestUtil;
import store.vantage.api.models.AuthResponse;
import store.vantage.api.utils.enc.AESUtil;
import store.vantage.api.utils.enc.RSAUtil;
...
public class AuthUtil {
    ...
    private static final String BASE_URL = "https://backend-dun-alpha.vercel.app";
    private static final String PRODUCT_ID = "63603d400259a4bf3a349b34";
    ...
    public static AuthResponse authenticate(String username) throws Exception {
        ...
        data.put("hwid", HWIDUtil.getHWID());
        ...
        return g.fromJson(String.valueOf(decrypted), AuthResponse.class);
    }
}
