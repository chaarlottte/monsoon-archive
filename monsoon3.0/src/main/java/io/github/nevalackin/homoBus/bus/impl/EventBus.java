...
public final class EventBus<Event> implements Bus<Event> {
    ...
    public void subscribe(final Object subscriber) {
        ...
        /*if(subscriber instanceof Speed) {
            if(Wrapper.getModule(TargetStrafe.class).isEnabled()) {
    ...
    public void post(final Event event) {
        ...
        while (i < listenersSize) {
            // if(Minecraft.getMinecraft().thePlayer == null || Minecraft.getMinecraft().theWorld == null || !Minecraft.getMinecraft().getNetHandler().doneLoadingTerrain) return;
