...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        return  (int)(this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1 : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6) *  Wrapper.getModule(BlockAnimations.class).speed.getValue());
    }
    ...
    protected void jump()
    {
        ...
        if (this.isSprinting())
        {
            ...
            float f = (sprint.isEnabled() && sprint.omni.getValue() ? MovementUtil.getDirection() : this.rotationYaw) * 0.017453292F;
    ...
    {
        eventMove.setY(this.motionY = (double)this.getJumpUpwardsMotion());
        ...
        if (this.isServerWorld())
        {
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
            {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
                {
                    ...
                    EventStrafing event = new EventStrafing(forward, strafe, f4, f5, this.rotationYaw, this.rotationPitch);
