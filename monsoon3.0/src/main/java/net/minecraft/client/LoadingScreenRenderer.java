            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                if (flag)
                {
                    ...
                    else
                    {
                        ...
                        worldrenderer.pos(0.0D, (double)l, 0.0D).func_181673_a(0.0D, (double)((float)l / f)).color(64, 64, 64, 255).end();
                        worldrenderer.pos((double)k, (double)l, 0.0D).func_181673_a((double)((float)k / f), (double)((float)l / f)).color(64, 64, 64, 255).end();
                        worldrenderer.pos((double)k, 0.0D, 0.0D).func_181673_a((double)((float)k / f), 0.0D).color(64, 64, 64, 255).end();
                        worldrenderer.pos(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).color(64, 64, 64, 255).end();
                        tessellator.draw();
                    }
                    ...
                    if (progress >= 0)
                    {
                        ...
                        worldrenderer.pos((double)j1, (double)k1, 0.0D).color(128, 128, 128, 255).end();
                        worldrenderer.pos((double)j1, (double)(k1 + i1), 0.0D).color(128, 128, 128, 255).end();
                        worldrenderer.pos((double)(j1 + l1), (double)(k1 + i1), 0.0D).color(128, 128, 128, 255).end();
                        worldrenderer.pos((double)(j1 + l1), (double)k1, 0.0D).color(128, 128, 128, 255).end();
                        worldrenderer.pos((double)j1, (double)k1, 0.0D).color(128, 255, 128, 255).end();
                        worldrenderer.pos((double)j1, (double)(k1 + i1), 0.0D).color(128, 255, 128, 255).end();
                        worldrenderer.pos((double)(j1 + progress), (double)(k1 + i1), 0.0D).color(128, 255, 128, 255).end();
                        worldrenderer.pos((double)(j1 + progress), (double)k1, 0.0D).color(128, 255, 128, 255).end();
                        tessellator.draw();
