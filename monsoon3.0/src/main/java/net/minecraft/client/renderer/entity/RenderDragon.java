...
public class RenderDragon extends RenderLiving<EntityDragon>
{
    ...
    protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_)
    {
        ...
        for (int j = 0; j <= 8; ++j)
        {
            ...
            worldrenderer.pos((double)(f9 * 0.2F), (double)(f10 * 0.2F), 0.0D).func_181673_a((double)f11, (double)f8).color(0, 0, 0, 255).end();
            worldrenderer.pos((double)f9, (double)f10, (double)f6).func_181673_a((double)f11, (double)f7).color(255, 255, 255, 255).end();
        }
