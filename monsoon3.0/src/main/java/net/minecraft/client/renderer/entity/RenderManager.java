...
public class RenderManager
{
    ...
    private void renderDebugBoundingBox(Entity entityIn, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_)
    {
        ...
        {
            float f1 = 0.01F;
            RenderGlobal.drawSelectionBoundingBox(new AxisAlignedBB(p_85094_2_ - (double)f, p_85094_4_ + (double)entityIn.getEyeHeight() - 0.009999999776482582D, p_85094_6_ - (double)f, p_85094_2_ + (double)f, p_85094_4_ + (double)entityIn.getEyeHeight() + 0.009999999776482582D, p_85094_6_ + (double)f), 255, 0, 0, 255);
        }
        ...
        worldrenderer.pos(p_85094_2_ + vec3.x * 2.0D, p_85094_4_ + (double)entityIn.getEyeHeight() + vec3.y * 2.0D, p_85094_6_ + vec3.z * 2.0D).color(0, 0, 255, 255).end();
        tessellator.draw();
