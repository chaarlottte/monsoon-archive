...
public class ItemModelGenerator
{
    ...
    private List<BlockPart> func_178397_a(TextureAtlasSprite sprite, String key, int layer)
    {
        ...
        for (ItemModelGenerator.Span itemmodelgenerator$span : this.func_178393_a(sprite))
        {
            float f2 = 0.0F;
            float f3 = 0.0F;
            float f4 = 0.0F;
            ...
            map.put(itemmodelgenerator$spanfacing.getFacing(), new BlockPartFace(null, layer, key, new BlockFaceUV(new float[] {f6, f8, f7, f9}, 0)));
