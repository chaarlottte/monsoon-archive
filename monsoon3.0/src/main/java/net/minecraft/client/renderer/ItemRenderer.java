...
public class ItemRenderer
{
    ...
    private void renderItemMap(AbstractClientPlayer clientPlayer, float p_178097_2_, float p_178097_3_, float p_178097_4_)
    {
        ...
        worldrenderer.pos(-7.0D, 135.0D, 0.0D).func_181673_a(0.0D, 1.0D).end();
        worldrenderer.pos(135.0D, 135.0D, 0.0D).func_181673_a(1.0D, 1.0D).end();
        worldrenderer.pos(135.0D, -7.0D, 0.0D).func_181673_a(1.0D, 0.0D).end();
        worldrenderer.pos(-7.0D, -7.0D, 0.0D).func_181673_a(0.0D, 0.0D).end();
        tessellator.draw();
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || (Wrapper.getModule(Aura.class).isEnabled()
                        && Wrapper.getModule(Aura.class).getTarget() != null
                        && !Wrapper.getModule(Aura.class).getTarget().isDead
                        && mc.thePlayer.getDistanceToEntity(Wrapper.getModule(Aura.class).getTarget()) <= Wrapper.getModule(Aura.class).getRange().getValue()
                        && mc.thePlayer != null
                        ...
                        case BLOCK:
                            ...
                            switch (Wrapper.getMonsoon().getModuleManager().getModule(BlockAnimations.class).animation.getValue()) {
                                ...
                                case OH_THE_MISERY:
                                    ...
                                    this.transformFirstPersonItem(f, f1);
                                    float var15 = MathHelper.sin((float) ((double)MathHelper.sqrt_float(f1) * 3.141592653589793D));
    ...
    private void exhibition(float equipProgress, float swingProgress) {
        ...
        switch (Wrapper.getMonsoon().getModuleManager().getModule(BlockAnimations.class).animation.getValue()) {
            ...
            case EXHIBOBO:
                ...
                GlStateManager.translate(0F, 0F + funny2 / 12, -0);
                GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
    ...
    private void func_178108_a(float p_178108_1_, TextureAtlasSprite p_178108_2_)
    {
        ...
        worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.pos(-1.0D, -1.0D, -0.5D).func_181673_a((double)f7, (double)f9).end();
        worldrenderer.pos(1.0D, -1.0D, -0.5D).func_181673_a((double)f6, (double)f9).end();
        worldrenderer.pos(1.0D, 1.0D, -0.5D).func_181673_a((double)f6, (double)f8).end();
        worldrenderer.pos(-1.0D, 1.0D, -0.5D).func_181673_a((double)f7, (double)f8).end();
        tessellator.draw();
        GlStateManager.popMatrix();
    ...
    private void renderWaterOverlayTexture(float p_78448_1_)
    {
        if (!Config.isShaders() || Shaders.isUnderwaterOverlay())
        {
            ...
            worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
            worldrenderer.pos(-1.0D, -1.0D, -0.5D).func_181673_a((double)(4.0F + f7), (double)(4.0F + f8)).end();
            worldrenderer.pos(1.0D, -1.0D, -0.5D).func_181673_a((double)(0.0F + f7), (double)(4.0F + f8)).end();
            worldrenderer.pos(1.0D, 1.0D, -0.5D).func_181673_a((double)(0.0F + f7), (double)(0.0F + f8)).end();
            worldrenderer.pos(-1.0D, 1.0D, -0.5D).func_181673_a((double)(4.0F + f7), (double)(0.0F + f8)).end();
            tessellator.draw();
            GlStateManager.popMatrix();
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    {
        if(Wrapper.getModule(NoRender.class).isEnabled() && Wrapper.getModule(NoRender.class).fireOverlay.getValue()) return;
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        ...
        for (int i = 0; i < 2; ++i)
        {
            ...
            worldrenderer.pos((double)f5, (double)f7, (double)f9).func_181673_a((double)f2, (double)f4).end();
            worldrenderer.pos((double)f6, (double)f7, (double)f9).func_181673_a((double)f1, (double)f4).end();
            worldrenderer.pos((double)f6, (double)f8, (double)f9).func_181673_a((double)f1, (double)f3).end();
            worldrenderer.pos((double)f5, (double)f8, (double)f9).func_181673_a((double)f2, (double)f3).end();
            tessellator.draw();
            GlStateManager.popMatrix();
        }
