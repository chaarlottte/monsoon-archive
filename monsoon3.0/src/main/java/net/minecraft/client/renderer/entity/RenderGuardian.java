...
public class RenderGuardian extends RenderLiving<EntityGuardian>
{
    ...
    public void doRender(EntityGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            worldrenderer.pos(d12, d0, d13).func_181673_a(0.4999D, d23).color(j, k, l, 255).end();
            worldrenderer.pos(d12, 0.0D, d13).func_181673_a(0.4999D, d22).color(j, k, l, 255).end();
            worldrenderer.pos(d14, 0.0D, d15).func_181673_a(0.0D, d22).color(j, k, l, 255).end();
            worldrenderer.pos(d14, d0, d15).func_181673_a(0.0D, d23).color(j, k, l, 255).end();
            worldrenderer.pos(d16, d0, d17).func_181673_a(0.4999D, d23).color(j, k, l, 255).end();
            worldrenderer.pos(d16, 0.0D, d17).func_181673_a(0.4999D, d22).color(j, k, l, 255).end();
            worldrenderer.pos(d18, 0.0D, d19).func_181673_a(0.0D, d22).color(j, k, l, 255).end();
            worldrenderer.pos(d18, d0, d19).func_181673_a(0.0D, d23).color(j, k, l, 255).end();
            double d24 = 0.0D;
            ...
            worldrenderer.pos(d4, d0, d5).func_181673_a(0.5D, d24 + 0.5D).color(j, k, l, 255).end();
            worldrenderer.pos(d6, d0, d7).func_181673_a(1.0D, d24 + 0.5D).color(j, k, l, 255).end();
            worldrenderer.pos(d10, d0, d11).func_181673_a(1.0D, d24).color(j, k, l, 255).end();
            worldrenderer.pos(d8, d0, d9).func_181673_a(0.5D, d24).color(j, k, l, 255).end();
            tessellator.draw();
