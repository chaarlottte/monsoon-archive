...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    private void renderEntityOnFire(Entity entity, double x, double y, double z, float partialTicks)
    {
        ...
        while (f3 > 0.0F)
        {
            ...
            worldrenderer.pos((double)(f1 - f2), (double)(0.0F - f4), (double)f5).func_181673_a((double)f8, (double)f9).end();
            worldrenderer.pos((double)(-f1 - f2), (double)(0.0F - f4), (double)f5).func_181673_a((double)f6, (double)f9).end();
            worldrenderer.pos((double)(-f1 - f2), (double)(1.4F - f4), (double)f5).func_181673_a((double)f6, (double)f7).end();
            worldrenderer.pos((double)(f1 - f2), (double)(1.4F - f4), (double)f5).func_181673_a((double)f8, (double)f7).end();
            f3 -= 0.45F;
            f4 -= 0.45F;
            f1 *= 0.9F;
            f5 += 0.03F;
    ...
    private void func_180549_a(Block blockIn, double p_180549_2_, double p_180549_4_, double p_180549_6_, BlockPos pos, float p_180549_9_, float p_180549_10_, double p_180549_11_, double p_180549_13_, double p_180549_15_)
    {
        if (blockIn.isFullCube())
        {
            ...
            if (d0 >= 0.0D)
            {
                ...
                worldrenderer.pos(d1, d3, d4).func_181673_a((double)f, (double)f2).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).end();
                worldrenderer.pos(d1, d3, d5).func_181673_a((double)f, (double)f3).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).end();
                worldrenderer.pos(d2, d3, d5).func_181673_a((double)f1, (double)f3).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).end();
                worldrenderer.pos(d2, d3, d4).func_181673_a((double)f1, (double)f2).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).end();
            }
        }
    }
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
        ...
        EventRenderVanillaNametag event = new EventRenderVanillaNametag(entityIn);
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            worldrenderer.pos((double)(-j - 1), (double)(-1 + i), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).end();
            worldrenderer.pos((double)(-j - 1), (double)(8 + i), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).end();
            worldrenderer.pos((double)(j + 1), (double)(8 + i), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).end();
            worldrenderer.pos((double)(j + 1), (double)(-1 + i), 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).end();
            tessellator.draw();
            GlStateManager.enableTexture2D();
