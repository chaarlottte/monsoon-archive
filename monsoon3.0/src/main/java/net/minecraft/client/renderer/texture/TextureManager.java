...
public class TextureManager implements ITickable, IResourceManagerReloadListener
{
    ...
    public final List<ITickable> listTickables = Lists.<ITickable>newArrayList();
    public final Map<String, Integer> mapTextureCounters = Maps.<String, Integer>newHashMap();
