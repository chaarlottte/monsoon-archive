...
import wtf.monsoon.impl.event.EventClientTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public NetworkManager lastNetworkManager;
    ...
    @Getter
    private final Animation blurAnimation = new Animation(() -> 400f, false, () -> Easing.LINEAR);

    @Getter
    private final Animation gradientAnimation = new Animation(() -> 400f, false, () -> Easing.LINEAR);
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        // Display.setTitle("Monsoon (Loading)");
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
    {
        ...
        worldrenderer.pos(0.0D, (double)this.displayHeight, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).end();
        worldrenderer.pos((double)this.displayWidth, (double)this.displayHeight, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).end();
        worldrenderer.pos((double)this.displayWidth, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).end();
        worldrenderer.pos(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).end();
        tessellator.draw();
    ...
    public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_)
    {
        ...
        worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.pos((double)p_181536_1_, (double)(p_181536_2_ + p_181536_6_), 0.0D).func_181673_a((double)((float)p_181536_3_ * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
        worldrenderer.pos((double)(p_181536_1_ + p_181536_5_), (double)(p_181536_2_ + p_181536_6_), 0.0D).func_181673_a((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
        worldrenderer.pos((double)(p_181536_1_ + p_181536_5_), (double)p_181536_2_, 0.0D).func_181673_a((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)p_181536_4_ * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
        worldrenderer.pos((double)p_181536_1_, (double)p_181536_2_, 0.0D).func_181673_a((double)((float)p_181536_3_ * f), (double)((float)p_181536_4_ * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        gradientAnimation.setState(guiScreenIn instanceof WindowGUI);
        blurAnimation.setState(guiScreenIn != null);

        if (this.currentScreen != null)
        {
            this.currentScreen.onGuiClosed();
            if(Screen.class.isAssignableFrom(currentScreen.getClass())) {
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            worldrenderer.pos((double)((float)j - (float)i * 1.1F), (double)((float)k - (float)i * 0.6F - 16.0F), 0.0D).color(200, 0, 0, 0).end();
            worldrenderer.pos((double)((float)j - (float)i * 1.1F), (double)(k + i * 2), 0.0D).color(200, 0, 0, 0).end();
            worldrenderer.pos((double)((float)j + (float)i * 1.1F), (double)(k + i * 2), 0.0D).color(200, 0, 0, 0).end();
            worldrenderer.pos((double)((float)j + (float)i * 1.1F), (double)((float)k - (float)i * 0.6F - 16.0F), 0.0D).color(200, 0, 0, 0).end();
            tessellator.draw();
            ...
            for (int l = 0; l < list.size(); ++l)
            {
                ...
                int l1 = j1 >> 8 & 255;
                int i2 = j1 & 255;
                worldrenderer.pos((double)j, (double)k, 0.0D).color(k1, l1, i2, 255).end();
                ...
                for (int j2 = i1; j2 >= 0; --j2)
                {
                    ...
                    worldrenderer.pos((double)((float)j + f1), (double)((float)k - f2), 0.0D).color(k1, l1, i2, 255).end();
                }
                ...
                for (int i3 = i1; i3 >= 0; --i3)
                {
                    ...
                    worldrenderer.pos((double)((float)j + f4), (double)((float)k - f5), 0.0D).color(k1 >> 1, l1 >> 1, i2 >> 1, 255).end();
                    worldrenderer.pos((double)((float)j + f4), (double)((float)k - f5 + 10.0F), 0.0D).color(k1 >> 1, l1 >> 1, i2 >> 1, 255).end();
                }
    ...
    public void clickMouse()
    {
        ...
        {
            // ViaMCP fix for attack order.
            // this.thePlayer.swingItem();
            if(this.objectMouseOver != null && !this.objectMouseOver.typeOfHit.equals(MovingObjectPosition.MovingObjectType.ENTITY)) this.thePlayer.swingItem();
    ...
    {
        Wrapper.getEventBus().post(new EventClientTick());
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        this.lastNetworkManager = this.myNetworkManager;
