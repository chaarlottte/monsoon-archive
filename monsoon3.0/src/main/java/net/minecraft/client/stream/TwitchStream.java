    ...
    public void func_152922_k()
    {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused())
        {
            ...
            if (flag)
            {
                ...
                worldrenderer.pos(0.0D, (double)f1, 0.0D).func_181673_a(0.0D, (double)f3).end();
                worldrenderer.pos((double)f, (double)f1, 0.0D).func_181673_a((double)f2, (double)f3).end();
                worldrenderer.pos((double)f, 0.0D, 0.0D).func_181673_a((double)f2, 0.0D).end();
                worldrenderer.pos(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).end();
                tessellator.draw();
