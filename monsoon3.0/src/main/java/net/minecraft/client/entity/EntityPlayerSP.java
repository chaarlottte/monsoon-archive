...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isSprinting() && ((sprint.isEnabled() && sprint.omni.getValue() ? this.movementInput.moveForward == 0 && this.movementInput.moveStrafe == 0 : this.movementInput.moveForward < f) || this.isCollidedHorizontally || !flag3))
        {
            this.setSprinting(false);
        }
