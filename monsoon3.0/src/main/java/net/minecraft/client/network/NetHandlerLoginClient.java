...
import wtf.monsoon.impl.event.EventConnectionSuccess;
...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public void handleLoginSuccess(S02PacketLoginSuccess packetIn)
    {
        ...
        EventConnectionSuccess eventConnectionSuccess = new EventConnectionSuccess(this.mc.getCurrentServerData(), this.gameProfile);
        Wrapper.getEventBus().post(eventConnectionSuccess);
    }
