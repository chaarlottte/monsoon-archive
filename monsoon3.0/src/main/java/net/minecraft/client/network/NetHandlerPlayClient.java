...
import wtf.monsoon.impl.event.EventDisconnected;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void onDisconnect(IChatComponent reason) {
        Wrapper.getEventBus().post(new EventDisconnected(reason, this.gameController.getCurrentServerData()));
    ...
    public void handleTeams(S3EPacketTeams packetIn)
    {
        ...
        {
            if(scoreplayerteam != null) scoreboard.removeTeam(scoreplayerteam);
        }
    }
