...
public class Shader
{
    ...
    public void loadShader(float p_148042_1_)
    {
        ...
        worldrenderer.pos(0.0D, (double)f1, 500.0D).color(255, 255, 255, 255).end();
        worldrenderer.pos((double)f, (double)f1, 500.0D).color(255, 255, 255, 255).end();
        worldrenderer.pos((double)f, 0.0D, 500.0D).color(255, 255, 255, 255).end();
        worldrenderer.pos(0.0D, 0.0D, 500.0D).color(255, 255, 255, 255).end();
        tessellator.draw();
