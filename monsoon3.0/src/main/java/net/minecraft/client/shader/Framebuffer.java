...
public class Framebuffer
{
    ...
    public void framebufferRenderExt(int p_178038_1_, int p_178038_2_, boolean p_178038_3_)
    {
        if (OpenGlHelper.isFramebufferEnabled())
        {
            ...
            worldrenderer.pos(0.0D, (double)f1, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).end();
            worldrenderer.pos((double)f, (double)f1, 0.0D).func_181673_a((double)f2, 0.0D).color(255, 255, 255, 255).end();
            worldrenderer.pos((double)f, 0.0D, 0.0D).func_181673_a((double)f2, (double)f3).color(255, 255, 255, 255).end();
            worldrenderer.pos(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, (double)f3).color(255, 255, 255, 255).end();
            tessellator.draw();
            this.unbindFramebufferTexture();
