...
import wtf.monsoon.impl.processor.HypixelAPIProcessor;
...
public class GuiNewChat extends Gui
{
    ...
    public void printChatMessage(IChatComponent chatComponent) {
       ...
       if(chatComponent.getUnformattedText().contains(Minecraft.getMinecraft().getSession().getUsername())) {
           String msg = chatComponent.getUnformattedText();
            if(msg.contains("by")) {
                msg = msg.replace(Minecraft.getMinecraft().getSession().getUsername(), "#");
        ...
        if (chatComponent.getFormattedText().contains("§aYour new API key is §r§b")) {
            ...
            Wrapper.getMonsoon().getProcessorManager().getProcessor(HypixelAPIProcessor.class).updateApiKey(complete);
        }
    }
