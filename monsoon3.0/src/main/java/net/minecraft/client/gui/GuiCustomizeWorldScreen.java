...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.field_175339_B != 0)
        {
            ...
            worldrenderer.pos((double)(this.width / 2 - 90), 185.0D, 0.0D).func_181673_a(0.0D, 2.65625D).color(64, 64, 64, 64).end();
            worldrenderer.pos((double)(this.width / 2 + 90), 185.0D, 0.0D).func_181673_a(5.625D, 2.65625D).color(64, 64, 64, 64).end();
            worldrenderer.pos((double)(this.width / 2 + 90), 100.0D, 0.0D).func_181673_a(5.625D, 0.0D).color(64, 64, 64, 64).end();
            worldrenderer.pos((double)(this.width / 2 - 90), 100.0D, 0.0D).func_181673_a(0.0D, 0.0D).color(64, 64, 64, 64).end();
            tessellator.draw();
