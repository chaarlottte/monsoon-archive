...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    class ListPreset extends GuiSlot
    {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_)
        {
            ...
            worldrenderer.pos((double)(i + 0), (double)(p_178051_2_ + 32), 0.0D).func_181673_a(0.0D, 1.0D).end();
            worldrenderer.pos((double)(i + 32), (double)(p_178051_2_ + 32), 0.0D).func_181673_a(1.0D, 1.0D).end();
            worldrenderer.pos((double)(i + 32), (double)(p_178051_2_ + 0), 0.0D).func_181673_a(1.0D, 0.0D).end();
            worldrenderer.pos((double)(i + 0), (double)(p_178051_2_ + 0), 0.0D).func_181673_a(0.0D, 0.0D).end();
            tessellator.draw();
        }
