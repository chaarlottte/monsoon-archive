...
public class GuiStreamIndicator
{
    ...
    public void render(int p_152437_1_, int p_152437_2_)
    {
        if (this.mc.getTwitchStream().isBroadcasting())
        {
            ...
            if (i > 0)
            {
                ...
                worldrenderer.pos((double)l, (double)j1, 0.0D).end();
                worldrenderer.pos((double)p_152437_1_, (double)j1, 0.0D).end();
                worldrenderer.pos((double)p_152437_1_, (double)i1, 0.0D).end();
                worldrenderer.pos((double)l, (double)i1, 0.0D).end();
                tessellator.draw();
    ...
    private void render(int p_152436_1_, int p_152436_2_, int p_152436_3_, int p_152436_4_)
    {
        ...
        worldrenderer.pos((double)(p_152436_1_ - 16 - p_152436_4_), (double)(p_152436_2_ + 16), (double)f).func_181673_a((double)f1, (double)f4).end();
        worldrenderer.pos((double)(p_152436_1_ - p_152436_4_), (double)(p_152436_2_ + 16), (double)f).func_181673_a((double)f3, (double)f4).end();
        worldrenderer.pos((double)(p_152436_1_ - p_152436_4_), (double)(p_152436_2_ + 0), (double)f).func_181673_a((double)f3, (double)f2).end();
        worldrenderer.pos((double)(p_152436_1_ - 16 - p_152436_4_), (double)(p_152436_2_ + 0), (double)f).func_181673_a((double)f1, (double)f2).end();
        tessellator.draw();
