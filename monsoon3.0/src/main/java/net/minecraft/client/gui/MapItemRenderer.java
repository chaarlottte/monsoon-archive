...
public class MapItemRenderer
{
    ...
    class Instance
    {
        ...
        private void render(boolean noOverlayRendering)
        {
            ...
            worldrenderer.pos((double)((float)(i + 0) + f), (double)((float)(j + 128) - f), -0.009999999776482582D).func_181673_a(0.0D, 1.0D).end();
            worldrenderer.pos((double)((float)(i + 128) - f), (double)((float)(j + 128) - f), -0.009999999776482582D).func_181673_a(1.0D, 1.0D).end();
            worldrenderer.pos((double)((float)(i + 128) - f), (double)((float)(j + 0) + f), -0.009999999776482582D).func_181673_a(1.0D, 0.0D).end();
            worldrenderer.pos((double)((float)(i + 0) + f), (double)((float)(j + 0) + f), -0.009999999776482582D).func_181673_a(0.0D, 0.0D).end();
            tessellator.draw();
            ...
            for (Vec4b vec4b : this.mapData.playersVisibleOnMap.values())
            {
                if (!noOverlayRendering || vec4b.func_176110_a() == 1)
                {
                    ...
                    worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
                    float f5 = -0.001F;
                    worldrenderer.pos(-1.0D, 1.0D, (double)((float)k * -0.001F)).func_181673_a((double)f1, (double)f2).end();
                    worldrenderer.pos(1.0D, 1.0D, (double)((float)k * -0.001F)).func_181673_a((double)f3, (double)f2).end();
                    worldrenderer.pos(1.0D, -1.0D, (double)((float)k * -0.001F)).func_181673_a((double)f3, (double)f4).end();
                    worldrenderer.pos(-1.0D, -1.0D, (double)((float)k * -0.001F)).func_181673_a((double)f1, (double)f4).end();
                    tessellator.draw();
