...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        buttons.clear();
        buttons.add(new Button(8, 8, Wrapper.getFont(), "Disable Aura", 8, (click) -> {
            if(click.equals(Click.LEFT)) {
                if(Wrapper.getModule(Aura.class).isEnabled())
                    Wrapper.getModule(Aura.class).toggle();
            }
        }));
        buttons.add(new Button(8, 30, Wrapper.getFont(), "Disable Stealer", 8, (click) -> {
            if(click.equals(Click.LEFT)) {
                if(Wrapper.getModule(ChestStealer.class).isEnabled())
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        buttons.forEach(b -> b.draw(mouseX,mouseY,0));
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        buttons.forEach(b -> b.mouseClicked(mouseX, mouseY, Click.getClick(mouseButton)));
    }
