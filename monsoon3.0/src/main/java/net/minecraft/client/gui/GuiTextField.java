...
public class GuiTextField extends Gui
{
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_)
    {
        ...
        worldrenderer.pos((double)p_146188_1_, (double)p_146188_4_, 0.0D).end();
        worldrenderer.pos((double)p_146188_3_, (double)p_146188_4_, 0.0D).end();
        worldrenderer.pos((double)p_146188_3_, (double)p_146188_2_, 0.0D).end();
        worldrenderer.pos((double)p_146188_1_, (double)p_146188_2_, 0.0D).end();
        tessellator.draw();
