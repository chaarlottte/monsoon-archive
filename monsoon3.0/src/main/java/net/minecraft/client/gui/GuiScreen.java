...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        if(Wrapper.getMonsoon() != null && Wrapper.getMonsoon().getCharacterManager() != null) Wrapper.getMonsoon().getCharacterManager().draw(mouseX, mouseY, partialTicks, this);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if(Wrapper.getMonsoon() != null && Wrapper.getMonsoon().getCharacterManager() != null) Wrapper.getMonsoon().getCharacterManager().onClick(mouseX, mouseY, mouseButton, this);
    }
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        if(Wrapper.getMonsoon() != null && Wrapper.getMonsoon().getCharacterManager() != null) Wrapper.getMonsoon().getCharacterManager().mouseReleased(mouseX, mouseY, state, this);
    }
    ...
    public void initGui()
    {
        if(Wrapper.getMonsoon() != null && Wrapper.getMonsoon().getCharacterManager() != null) Wrapper.getMonsoon().getCharacterManager().initGui(this);
    ...
    public void drawBackground(int tint)
    {
        ...
        worldrenderer.pos(0.0D, (double)this.height, 0.0D).func_181673_a(0.0D, (double)((float)this.height / 32.0F + (float)tint)).color(64, 64, 64, 255).end();
        worldrenderer.pos((double)this.width, (double)this.height, 0.0D).func_181673_a((double)((float)this.width / 32.0F), (double)((float)this.height / 32.0F + (float)tint)).color(64, 64, 64, 255).end();
        worldrenderer.pos((double)this.width, 0.0D, 0.0D).func_181673_a((double)((float)this.width / 32.0F), (double)tint).color(64, 64, 64, 255).end();
        worldrenderer.pos(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, (double)tint).color(64, 64, 64, 255).end();
        tessellator.draw();
    }
