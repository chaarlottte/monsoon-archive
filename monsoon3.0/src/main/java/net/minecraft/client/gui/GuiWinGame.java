...
public class GuiWinGame extends GuiScreen
{
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_)
    {
        ...
        f3 = f3 * f3;
        f3 = f3 * 96.0F / 255.0F;
        worldrenderer.pos(0.0D, (double)this.height, (double)this.zLevel).func_181673_a(0.0D, (double)(f * f2)).func_181666_a(f3, f3, f3, 1.0F).end();
        worldrenderer.pos((double)i, (double)this.height, (double)this.zLevel).func_181673_a((double)((float)i * f2), (double)(f * f2)).func_181666_a(f3, f3, f3, 1.0F).end();
        worldrenderer.pos((double)i, 0.0D, (double)this.zLevel).func_181673_a((double)((float)i * f2), (double)(f1 * f2)).func_181666_a(f3, f3, f3, 1.0F).end();
        worldrenderer.pos(0.0D, 0.0D, (double)this.zLevel).func_181673_a(0.0D, (double)(f1 * f2)).func_181666_a(f3, f3, f3, 1.0F).end();
        tessellator.draw();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int k1 = this.height;
        worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.pos(0.0D, (double)k1, (double)this.zLevel).func_181673_a(0.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).end();
        worldrenderer.pos((double)j1, (double)k1, (double)this.zLevel).func_181673_a(1.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).end();
        worldrenderer.pos((double)j1, 0.0D, (double)this.zLevel).func_181673_a(1.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).end();
        worldrenderer.pos(0.0D, 0.0D, (double)this.zLevel).func_181673_a(0.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).end();
        tessellator.draw();
