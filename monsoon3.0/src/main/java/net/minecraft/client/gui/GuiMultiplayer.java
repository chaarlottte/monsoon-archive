...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(690,  115, 5, 110, 20, "reconnect to proxy (debug)"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if(button.id == 690) {
                ProxyInitThread proxyInitThread = new ProxyInitThread("proxy-nl.privateinternetaccess.com", 1080, "x3700731", "MrUx2FJPf4");
