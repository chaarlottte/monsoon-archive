...
public class TexturedQuad
{
    ...
    public void draw(WorldRenderer renderer, float scale)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            ...
            renderer.pos(positiontexturevertex.vector3D.x * (double)scale, positiontexturevertex.vector3D.y * (double)scale, positiontexturevertex.vector3D.z * (double)scale).func_181673_a((double)positiontexturevertex.texturePositionX, (double)positiontexturevertex.texturePositionY).func_181663_c(f, f1, f2).end();
        }
