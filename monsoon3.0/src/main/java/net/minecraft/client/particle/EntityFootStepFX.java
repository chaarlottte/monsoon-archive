...
public class EntityFootStepFX extends EntityFX
{
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_)
    {
        ...
        worldRendererIn.pos((double)(f3 - 0.125F), (double)f4, (double)(f5 + 0.125F)).func_181673_a(0.0D, 1.0D).func_181666_a(f6, f6, f6, f1).end();
        worldRendererIn.pos((double)(f3 + 0.125F), (double)f4, (double)(f5 + 0.125F)).func_181673_a(1.0D, 1.0D).func_181666_a(f6, f6, f6, f1).end();
        worldRendererIn.pos((double)(f3 + 0.125F), (double)f4, (double)(f5 - 0.125F)).func_181673_a(1.0D, 0.0D).func_181666_a(f6, f6, f6, f1).end();
        worldRendererIn.pos((double)(f3 - 0.125F), (double)f4, (double)(f5 - 0.125F)).func_181673_a(0.0D, 0.0D).func_181666_a(f6, f6, f6, f1).end();
