...
public class CustomSkyLayer
{
    ...
    private void renderSide(Tessellator tess, int side)
    {
        ...
        worldrenderer.pos(-100.0D, -100.0D, -100.0D).func_181673_a(d0, d1).end();
        worldrenderer.pos(-100.0D, -100.0D, 100.0D).func_181673_a(d0, d1 + 0.5D).end();
        worldrenderer.pos(100.0D, -100.0D, 100.0D).func_181673_a(d0 + 0.3333333333333333D, d1 + 0.5D).end();
        worldrenderer.pos(100.0D, -100.0D, -100.0D).func_181673_a(d0 + 0.3333333333333333D, d1).end();
        tess.draw();
    }
