...
public class CustomLoadingScreen
{
    ...
    public void drawBackground(int width, int height)
    {
        ...
        worldrenderer.pos(0.0D, (double)height, 0.0D).func_181673_a(d3, d4 + d2).color(255, 255, 255, 255).end();
        worldrenderer.pos((double)width, (double)height, 0.0D).func_181673_a(d3 + d1, d4 + d2).color(255, 255, 255, 255).end();
        worldrenderer.pos((double)width, 0.0D, 0.0D).func_181673_a(d3 + d1, d4).color(255, 255, 255, 255).end();
        worldrenderer.pos(0.0D, 0.0D, 0.0D).func_181673_a(d3, d4).color(255, 255, 255, 255).end();
        tessellator.draw();
    }
}
