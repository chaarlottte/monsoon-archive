...
public class ShadersRender
{
    ...
    public static boolean renderEndPortal(TileEntityEndPortal te, double x, double y, double z, float partialTicks, int destroyStage, float offset)
    {
        ...
        else
        {
            ...
            int i = 240;
            worldrenderer.pos(x, y + (double)offset, z + 1.0D).func_181666_a(f1, f2, f3, 1.0F).func_181673_a((double)(f4 + f6), (double)(f4 + f6)).func_181671_a(i, i).end();
            worldrenderer.pos(x + 1.0D, y + (double)offset, z + 1.0D).func_181666_a(f1, f2, f3, 1.0F).func_181673_a((double)(f4 + f6), (double)(f5 + f6)).func_181671_a(i, i).end();
            worldrenderer.pos(x + 1.0D, y + (double)offset, z).func_181666_a(f1, f2, f3, 1.0F).func_181673_a((double)(f5 + f6), (double)(f5 + f6)).func_181671_a(i, i).end();
            worldrenderer.pos(x, y + (double)offset, z).func_181666_a(f1, f2, f3, 1.0F).func_181673_a((double)(f5 + f6), (double)(f4 + f6)).func_181671_a(i, i).end();
            tessellator.draw();
